...
public class Townspeople {
	...
	public Townspeople(JDA bot, GuildMessageReceivedEvent e, String[] data) {
		this.bot = bot;
		this.e = e;
		this.data = data;
	}
	...
	public void buildDocs() {
		try {
			...
			File xml = new File(BotConfiguration.PATH + "docs/NPC/Townspeople/" + data[0] + ".xml");
	        ...
	        Node node = doc.getElementsByTagName("Townspeople").item(0);
