...
public class Bachelorettes {
	...
	public Bachelorettes(JDA bot, GuildMessageReceivedEvent e, String[] data) {
		this.bot = bot;
		this.e = e;
		this.data = data;
	}
	...
	public void buildDocs() {
		try {
			...
			File xml = new File(BotConfiguration.PATH + "docs/NPC/Bachelorettes/" + data[0] + ".xml");
	        ...
	        Node node = doc.getElementsByTagName("Bachelorettes").item(0);
