...
public class Bachelors {
	...
	public Bachelors(JDA bot, GuildMessageReceivedEvent e, String[] data) {
		this.bot = bot;
		this.e = e;
		this.data = data;
	}
	...
	public void buildDocs() {
		try {
			...
			File xml = new File(BotConfiguration.PATH + "docs/NPC/Bachelor/" + data[0] + ".xml");
	        ...
	        Node node = doc.getElementsByTagName("Bachelors").item(0);
